...
function ServiceRequestLog ({availableServices}: ListOfServices) {
    ...
    const submitRequest = () => {
        if (singleServiceRequest.name && !isNaN(singleServiceRequest.room) && singleServiceRequest.deliveryDate) {
    ...
    return (
        <>
            ...
            <Grid container className="container" columnSpacing={4} marginX={0} width={'100%'}>

                {/*Grid container which holds the buttons and takes up 1/4 of the width */}
                <Grid container xs={3} className="availableServices" direction={"column"} alignItems="center" justifyContent={"center"}>
                    ...
                    <Stack direction={"column"} spacing={4}>
                        ...
                        <div className="service-form">
                            ...
                            <div className="form-item">
                                ...
                                <TextField variant={"filled"} multiline id="details" value={singleServiceRequest.details}
                            ...
                            <Stack spacing={4}>
                                ...
                                <div className="form-item">
                                    ...
                                    <TextField variant={"filled"} type="number" id="room" value={singleServiceRequest.room}
                                               onChange={e => setSingleServiceRequest({
                                                   ...singleServiceRequest,
                                ...
                                <div className="form-item">
                                    ...
                                    <TextField variant={"filled"} type="text" id="name" value={singleServiceRequest.name}
                                               onChange={e => setSingleServiceRequest({
                                                   ...singleServiceRequest,
                                                   name: e.target.value
                                               })}
                                ...
                                <div className="form-item">
                                    ...
                                    <TextField variant={"filled"} type="date" id="deliveryDate" value={singleServiceRequest.deliveryDate}
                                               onChange={e => setSingleServiceRequest({
                                                   ...singleServiceRequest,
                ...
                {/*My Request Format*/}
                <Grid className={"service-request-log"} item xs={4} sx={{margin:"auto"}}>
