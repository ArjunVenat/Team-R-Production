                ...
                contentComponent = (
                    <>
                        <div className="mt-[-19rem] bg-white rounded-lg">
                            <h2 className="mb-4 p-4 font-bold text-lg">Switch Content Section</h2>
                        ...
                        <div className="bg-white rounded-lg p-5">
                            ...
                            <div className="flex flex-col space-y-4">
                                {availableServices.map((serviceOption: string) => (
                                    <Button key={serviceOption} variant="contained"
                                            onClick={() => setSingleServiceRequest({
                                                ...singleServiceRequest,
                                                type: serviceOption
                                            })}>
                                        {serviceOption}
                ...
                <div className="inline-block w-[60%]" >
                    <div className="content" id="content">
                        ...
                        <div className="mt-[5rem]" >
                            <div className="bg-white rounded-lg p-4" style={{height: '30vh'}}>
